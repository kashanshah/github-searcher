            ...
            <div className={styles.cardHeaderContent}>
                ...
                {!props.showDetails ?
                    <span onClick={props.onButtonClick}
                          className={styles.cardHeaderBtn}>{props.loading ? 'Loading...' : (props.showDetails ? 'Read Less' : 'Read More')}</span>
                    :
    ...
    render() {
        ...
        return (
            <div className={styles.card}>
                ...
                <CardHeader full_name={data.data.full_name} pushed_at={data.data.pushed_at} />
                <CardBody title={data.data.name} link={data.data.html_url} text={data.data.description} forks_count={data.data.forks_count} stars={data.data.stargazers_count} language={data.data.language} languages_url={data.data.languages_url} updated_at={data.data.updated_at}/>
            </article>*/}
